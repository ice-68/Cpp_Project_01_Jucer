...
/**
*/
class _01AudioProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    _01AudioProcessor();
    ~_01AudioProcessor() override;
...
private:
    DSP_Order dspOrder;
    std::vector<juce::dsp::ProcessorBase*> dspInstances;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (_01AudioProcessor)
};
